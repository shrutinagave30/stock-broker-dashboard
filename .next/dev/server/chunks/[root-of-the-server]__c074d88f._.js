...
"[project]/app/api/unsubscribe/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (!userId || !symbol) {
            return Response.json({
                message: "User ID and symbol required"
            }, {
                status: 400
            });
        }
        const success = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$stock$2d$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["unsubscribeStock"])(userId, symbol);
        if (!success) {
            return Response.json({
                message: "Stock not found in subscriptions"
            }, {
                status: 404
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c074d88f._.js.map